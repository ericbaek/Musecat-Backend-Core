		...
		jsonData := `[
			...
			},
			{
				...
				"fields": [
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_2594468147",
						"hidden": false,
						"id": "relation567091251",
						"maxSelect": 999,
						"minSelect": 0,
						"name": "owns",
						"presentable": false,
				...
				"indexes": [
					...
					"CREATE UNIQUE INDEX ` + "`" + `idx_username_lower__pb_users_auth_` + "`" + `\nON ` + "`" + `user` + "`" + ` (` + "`" + `username` + "`" + ` COLLATE NOCASE)\nWHERE ` + "`" + `username` + "`" + ` != ''\n"
				],
				"listRule": null,
				"manageRule": null,
				"mfa": {
			...
			{
				"createRule": "public = false && createdBy = @request.auth.id",
				"deleteRule": "public = false && createdBy = @request.auth.id",
				"fields": [
					{
						"autogeneratePattern": "[a-z0-9]{15}",
						"hidden": false,
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_1854969543",
						"hidden": false,
						"id": "relation2423878995",
						"maxSelect": 1,
						"minSelect": 0,
						"name": "basic",
						"presentable": true,
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_1962106393",
						"hidden": false,
						"id": "relation2317008269",
						"maxSelect": 1,
						"minSelect": 0,
						"name": "hour",
						"presentable": false,
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_1503599144",
						"hidden": false,
						"id": "relation2609146292",
						"maxSelect": 1,
						"minSelect": 0,
						"name": "sns",
						"presentable": false,
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_60641264",
						"hidden": false,
						"id": "relation602538133",
						"maxSelect": 1,
						"minSelect": 0,
						"name": "gtk",
						"presentable": false,
			...
			},
			{
				...
				"id": "pbc_2222827957",
				"indexes": [],
				"listRule": "(arcade.public = true || arcade.createdBy.id = @request.auth.id)",
				"name": "arcade_changelog",
				"system": false,
				"type": "base",
				"updateRule": null,
				"viewRule": ""
			...
			},
			{
				...
				"id": "pbc_579475151",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_sxio9MX0Uz` + "`" + ` ON ` + "`" + `arcade_game_atoms` + "`" + ` (` + "`" + `molecule` + "`" + `)"
				],
				"listRule": null,
				"name": "arcade_game_atoms",
				"system": false,
				"type": "base",
				"updateRule": null,
				"viewRule": null
			...
			{
				"createRule": "",
				"deleteRule": "public = false && createdBy.id = @request.auth.id",
				"fields": [
					{
						"autogeneratePattern": "[a-z0-9]{15}",
						"hidden": false,
			...
			},
			{
				...
				"id": "pbc_2329154468",
				"indexes": [],
				"listRule": "createdBy.id = @request.auth.id",
				"name": "arcade_request_admin",
				"system": false,
				"type": "base",
				"updateRule": null,
				"viewRule": null
			...
			},
			{
				...
				"id": "pbc_2332917541",
				"indexes": [
					"CREATE INDEX ` + "`" + `idx_gUrsEyNJHA` + "`" + ` ON ` + "`" + `user_level_log` + "`" + ` (\n  ` + "`" + `user` + "`" + `,\n  ` + "`" + `kind` + "`" + `\n)"
				],
				"listRule": null,
				"name": "user_level_log",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_2258110427",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_user_level_user` + "`" + ` ON ` + "`" + `user_level` + "`" + ` (` + "`" + `user` + "`" + `)"
				],
				"listRule": null,
				"name": "user_level",
				"system": false,
			...
			},
			{
				...
				"id": "pbc_3180792493",
				"indexes": [
					"CREATE UNIQUE INDEX idx_arcade_visit_user_arcade_day ON arcade_visit (user, arcade, visit_day)",
					"CREATE INDEX idx_arcade_visit_arcade ON arcade_visit (arcade)"
				],
				"listRule": null,
				"name": "arcade_visit",
				"system": false,
